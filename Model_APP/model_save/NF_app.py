...
cv_fold = 10
# Featurizers
atom_bond_type = 'Canonical' #'AttentiveFP' or 'Canonical' (default)
...
with open('gwp100_best_NF_hyperparameters_trial.json', 'r') as f:
...
best_model.load_state_dict(torch.load('gwp100_best_NF_model_trial.pth'))
...
print(r2_train)
# Export to CSV files
train_results.to_csv('gwp100_NF_train_predictions.csv', index=False)
test_results.to_csv('gwp100_NF_test_predictions.csv', index=False)
