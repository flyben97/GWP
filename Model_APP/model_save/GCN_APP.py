...
from GNN_Model import Data_process
from GNN_Model import Model_performance
from GNN_Model.Get_graphs import batch_smiles_to_graph
from GNN_Model.Early_stopping import EarlyStopping
from GNN_Model.Initialize_model import GATv2_initialize_model,GCN_initialize_model,NF_initialize_model,AFP_initialize_model,MPNN_initialize_model
# Read data
...
with open('gwp500_best_GCN_hyperparameters_trial.json', 'r') as f:
